                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group {{ ($errors->has('division'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('division', (!empty($fdata->division) ? $fdata->division : NULL), ['class' => 'form-control', 'placeholder' => ' division...']) }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group {{ ($errors->has('district'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('district', (!empty($fdata->district) ? $fdata->district : NULL), ['class' => 'form-control', 'placeholder' => ' district...']) }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('thana'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('thana', (!empty($fdata->thana) ? $fdata->thana : NULL), ['class' => 'form-control', 'placeholder' => ' thana...']) }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('postoffice'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('postoffice', (!empty($fdata->postoffice) ? $fdata->postoffice : NULL), ['class' => 'form-control', 'placeholder' => ' postoffice...']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('postcode'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('postcode', (!empty($fdata->postcode) ? $fdata->postcode : NULL), ['class' => 'form-control', 'placeholder' => ' postcode...']) }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('village'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('village', (!empty($fdata->village) ? $fdata->village : NULL), ['class' => 'form-control', 'placeholder' => ' village...']) }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('ward'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('ward', (!empty($fdata->ward) ? $fdata->ward : NULL), ['class' => 'form-control', 'placeholder' => ' ward...']) }}
                                        @if($errors->has('ward'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ ($errors->has('para'))? 'has-error' : '' }}">
                                        ...
                                        {{ Form::text('para', (!empty($fdata->para) ? $fdata->para : NULL), ['class' => 'form-control', 'placeholder' => ' para...']) }}
                                        @if($errors->has('para'))

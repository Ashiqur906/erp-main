...
@section('title',  (!empty($fdata->id) ? 'Edit Receipt Voucher' : 'New  Receipt Voucher'))
@section('content')
            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title mb-0">Receipt Voucher</h3>
                    </div>
                    <!-- @dump($fdata) -->
                    <!-- /.card-header -->
                    <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" id="RecieptHead">
                            ...
                            <div class="col-4">
                                <div class="form-group row">
                                    {{ Form::label('id', 'Receipt voucher no',['class' => 'col-sm-6 text-right col-form-label'])}}
                                    <div class="col-sm-6">
                        ...
                        <table class="table  table-sm table-striped">
                            ...
                            <tbody id="appendRow">
                                ...
                                @include('receipt::part.old_form', ['rows' => $olds])
                                @php
                                ...
                                @include('receipt::part.edit_form', ['rows' => $fdata->details])
                                @php
                                ...
                                $rn = 2;
                                @endphp
                                @include('receipt::part.default_form', ['rows' => $default_form])
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    <td colspan="4" class="text-right" style="border-top: 0">Total Amount</td>
...
<script>
    ...
    function append_row() {
        var $ = jQuery;
            ...
            let route = "{{ route('receipt.ajax.rowitem') }}";
            var rows = count;
            $.ajax({
                type:'GET',
                url:route,
    ...
    function selectAccount(self) {
       ...
       // alert(type);
        ...
        if(pid){
            //alert(pid);
            let route = "{{ route('receipt.ajax.account') }}";
            var rows = count;
            $.ajax({
                type:'GET',
                url:route,

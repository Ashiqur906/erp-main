...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-5">
                {{ Form::open(['method' => 'POST', 'route'=>'unit.store']) }}
                <div class="card  {{(!empty($fdata) ?'card-warning' : 'card-primary')}}">
                    <div class="card-header">
                        <h3 class="card-title mb-0">
                            {{(!empty($fdata) ?'Edit' : 'Add New')}} Unit
                        </h3>
                    </div>
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('unit.all')}}" class="btn btn-sm btn-success">
                            <span class="material-icons">add_circle_outline</span> Unit
                        </a>
                    </div>

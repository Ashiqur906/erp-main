                        ...
                        <div class="row" id="RecieptHead">
                            <div class="col-md-8 ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        {{ Form::select('party_ac', AccountSelect(),(!empty($fdata->party_ac) ? $fdata->party_ac : NULL), ['class' => (($errors->has('party_ac')? 'is-invalid': ''). ' form-control select2'), 'placeholder' => 'Select' ]) }}
                                        @error('party_ac')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        {{ Form::select('sale_ledger', AccountSelect(),(!empty($fdata->sale_ledger) ? $fdata->sale_ledger : NULL), ['class' => (($errors->has('sale_ledger')? 'is-invalid': ''). ' form-control select2'), 'placeholder' => 'Select' ]) }}
                                        @error('sale_ledger')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-check form-check-inline">
                                  ...
                                  <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        ...
                                        {{ Form::radio('price_type','DP',((!empty($fdata->price_type) && $fdata->price_type == 'DP') ? true : false), ['class'=>'form-check-input']) }} DP
                                    </label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <label class="form-check-label">

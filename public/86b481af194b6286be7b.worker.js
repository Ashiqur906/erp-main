...
self.addEventListener('message', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
    var _e$data, type, key, val;

    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _e$data = e.data, type = _e$data.type, key = _e$data.key, val = _e$data.val;
            _context.t0 = type;
            _context.next = _context.t0 === 'get' ? 4 : _context.t0 === 'set' ? 6 : _context.t0 === 'del' ? 8 : _context.t0 === 'clr' ? 10 : _context.t0 === 'keys' ? 12 : 14;
            break;
